montageDefine("daa4856","vendor/requirejs/tests/relative/relativeBaseUrl-tests",{dependencies:[],factory:function(require,exports,module){//Use a property on require so if the test runs in node, it is visible.
